...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black py-16 w-full">
      ...
      <div className="w-[100%] m-auto lg:hidden">
          {/* Title */}
        ...
        <div className="w-[70%] border-r border-white pr-8 hidden lg:block">
        ...
        {/* Right Section */}
        {/* Right Section */} 
        <div className="w-[40%] pl-8 hidden lg:block">
          {/* Title */}
          <h3 className="text-white text-xl font-bold mb-4">
            GET IN <span className="text-[#E45D25]">TOUCH</span>
          </h3>
      ...
      <div className='h-[2px] w-[80%] m-auto mt-4 bg-gray-100'></div>

      <div className="w-[80%] lg:hidden m-auto mt-6">
