...
//       style={{ width: '100%', height: '32.3125rem', minWidth:"377px" }} // Fixed width and height
//     >
//       {/* Background Image */}
//       <Image
//         src={bgImage}
...
//           <>
//             {/* Project Heading */}
//             <h2 className="text-white text-center text-[1.875rem] font-bold leading-[145%] mb-4 w-full">
//               {topic}
//             </h2>
//             {/* Project Description */}
...
type BlogPostCardProps = {
  ...
  type?: 'blog' | 'project';
  description?: string;
  className?: string; // Optional className prop for external styling
};

const BlogPostCard: React.FC<BlogPostCardProps> = ({ bgImage, topic, type = 'blog', description, className }) => {
  return (
    <div
      className={`relative rounded-xl overflow-hidden ${className}`} // Apply className prop here
      style={{ width: '100%', height: '32.3125rem', minWidth: '377px' }} // Fixed width and height
    >
      {/* Background Image */}
      <Image
