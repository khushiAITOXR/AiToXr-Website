...
const AiML: React.FC = () => {
  ...
  const heroSectionProps = {
    backgroundImage: '/data-hero.jpg', // Provide the path to the background image
    paragraphText1: 'Create. Collaborate. Develop.', // Primary text
    heroSectionTextLine1: 'Data Science',
  ...
  // About section data
  const aboutItems = [
    { id: 1, title: 'What is Data Science ?', content: 'Details about our history' },
  ...
  const paragraphContent = `Data Science is the driving force behind AI and ML, as it involves extracting insights from structured and unstructured data. Combining mathematics, statistics, and advanced computing, Data Science helps organizations turn raw data into meaningful, actionable insights.
...
With data science methodologies, businesses can refine processes, reduce costs, and enhance their decision-making capabilities.  
`; 
